...
<div class="page-header-content">
    <div class="page-title">
        <h4><span class="text-semibold">Doctor's Appointment</small></span></h4>
    </div>
            ...
            <table id="doctor" class="table datatable-responsive">
                <thead>
                    <tr>
                        ...
                        <th>Room</th>
                        <th>Date</th>
                        <th colspan=2 style="width:1px" class="text-center">Action</th>
                        </tr>
                </thead>
                <tbody>
                        ...
                        <!-- 1st -->
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group ">
                                        <input type="text" name="patient_code" onchange="filter_patient()" id="patient_code" class="form-control">
                                    </div>
                                </div>
                               ...
                               <!-- 3rd  -->
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="occupation" id="occupation" ng-model="occupation" class="form-control">
                                    </div>
                                </div>
                                <!-- 5th -->
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name1" id="name1" ng-model="name1" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <label for="">Address</label>
                                    <div class="form-group">
                                        <input type="text" name="address1" id="address1" ng-model="address1" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="contact1" id="contact1" ng-model="contact1" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name2" id="name2" ng-model="name2" class="form-control" required>
                                ...
                                <div class="col-sm-6">
                                    <label for="">Address</label>
                                    <div class="form-group">
                                        <input type="text" name="address2" id="address2" ng-model="address2" class="form-control" required>
                                ...
                                <div class="col-sm-3">
                                    <label for="">Tel. No.</label>
                                    <div class="form-group">
                                        <input type="text" name="contact2" id="contact2" ng-model="contact2" class="form-control" required>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name3" id="name3" ng-model="name3" class="form-control" required>
                                ...
                                <div class="col-sm-6">
                                    <label for="">Address</label>
                                    <div class="form-group">
                                        <input type="text" name="address3" id="address3" ng-model="address3" class="form-control" required>
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <label for="">Tel. No.</label>
                                    <div class="form-group">
                                        <input type="text" name="contact3" id="contact3" ng-model="contact3" class="form-control" required>
                        ...
                        <div class="tab-pane" id="basic-tab2">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="days" id="days" ng-model="days" class="form-control">
