                ...
                <tbody>
                    <?php foreach($data['all_patients'] as $row) { ?> 
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-cexnter"><a class="btn btn-primary" href="<?=URL?>doctor/view_patients/<?=$row['admissions_id']?>">View</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
                ...
                <tbody>
                    <?php foreach($data['outpatients'] as $rows) { ?> 
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-cexnter"><a class="btn btn-primary" href="<?=URL?>doctor/view_patient/<?=$rows['outpatients_id']?>">View</a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
