                        ...
                        <div class="tab-pane" id="basic-tab2">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input readonly type="datetime-local" name="admission_date_time" id="admission_date_time" ng-model="admission_date_time" class="form-control" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input readonly type="datetime-local" name="discharged_date_time" id="discharged_date_time" ng-model="discharged_date_time" class="form-control" >
                                    </div>
                                </div>
