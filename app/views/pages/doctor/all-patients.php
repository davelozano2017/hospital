                ...
                <tbody>
                    <?php foreach($data['all_patients'] as $row) { ?> 
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-cexnter"><a href="<?=URL?>doctor/view_patients/<?=$row['admissions_id']?>"><i class="icon-eye"></i></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
                ...
                <tbody>
                    <?php foreach($data['outpatients'] as $rows) { ?> 
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-cexnter"><a href="<?=URL?>doctor/view_patient/<?=$rows['outpatients_id']?>"><i class="icon-eye"></i></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
